...
namespace Bbt.Campaign.Api.Controllers
{
    public class CampainAchievementController : BaseController<CampainAchievementController>
    {
        ...
        [HttpPost]
        [Route("update")]
        public async Task<IActionResult> Update(CampaignAchievementUpdateRequest campaignAchievement)
        {
        ...
        {
            var result = await _campaignAchievementService.GetInsertFormAsync();
            return Ok(result);
        }
        /// <summary>
        ...
        {
            var result = await _campaignAchievementService.GetUpdateFormAsync(id);
            return Ok(result);
        }
        /// <summary>
