    ...
    public class CampaignDbInitializer
    {
        ...
        public void Seed()
        {
            ...
            modelBuilder.Entity<SectorEntity>().HasData(
                ...
                new SectorEntity() { Id = 2, Code = "IT", Name = "Bilişim", CreatedBy = "1", CreatedOn = DateTime.Now, IsDeleted = false, },
                new SectorEntity() { Id = 3, Code = "Bnk", Name = "Bankacılık", CreatedBy = "1", CreatedOn = DateTime.Now, IsDeleted = false, }
            );
            ...
            modelBuilder.Entity<ViewOptionEntity>().HasData(
                ...
                new ViewOptionEntity() { Id = 2, Code = "GK", Name = "Geçici Kampanyalar", CreatedBy = "1", CreatedOn = DateTime.Now, IsDeleted = false, },
            ...
            modelBuilder.Entity<AchievementFrequencyEntity>().HasData(
                new AchievementFrequencyEntity() { Id = 1, Name = "Haftalık", CreatedBy = "1", CreatedOn = DateTime.Now, IsDeleted = false },
